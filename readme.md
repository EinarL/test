...
- 30% – Lestur gagna
  - 15% – Lesa JSON skrá og útfrá henni CSV skrá, hugað að forsendum
  - 15% – HTML skrár búnar til útfrá gögnum
- 20% – Test og lint
  - 5% – Test skrifuð með Jest og keyra skv. forskrift og með GitHub Actions
  - 10% – Coverage a.m.k. 80% og test allar skrár hafa test
  - 5% – Engar villur í `eslint` og `stylelint` og ekki slökkt inline á neinum reglum
